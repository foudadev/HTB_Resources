...
| `smbclient -N -L \\\\10.129.42.253` | List SMB Shares -L => retrieve a list of available shares, -N => suppresses the password prompt|
| `smbclient \\\\10.129.42.253\\users` | Connect to an SMB share |
| `smbclient -U bob \\\\10.129.42.253\\users` | -U => login with specific user|
